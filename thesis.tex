...
\graphicspath{{Figure/VisualReasoning/}{Images/VisualReasoning/}}
\renewcommand{\floatpagefraction}{.99}
...
\section{Results}
We have tested 18 students, and are considering increasing sample size once the summer semester begins. 

\todo[inline]{Add graphs showing results of student testing to date.}
