...
{\centering \includegraphics[width=.4\textwidth]{Figure/sineIllusion/fig-original-1} 
...
{\centering \includegraphics[width=\textwidth]{Figure/sineIllusion/fig-simulation1Sine-1} 
...
{\centering \includegraphics[width=\textwidth]{Figure/sineIllusion/fig-simulation1Sine2-1} 
...
{\centering \includegraphics[width=\textwidth]{Figure/sineIllusion/fig-simulation1Sine3-1} 
...
{\centering \includegraphics[width=0.32\textwidth]{Figure/FeatureHierarchy/fig-gestalt1-1} 
\includegraphics[width=0.32\textwidth]{Figure/FeatureHierarchy/fig-gestalt1-2} 
\includegraphics[width=0.32\textwidth]{Figure/FeatureHierarchy/fig-gestalt1-3} 
...
{\centering \includegraphics[width=\textwidth]{Figure/FeatureHierarchy/fig-trends-1} 
...
\end{knitrout}
\caption[Effect of trend model $M_T$ parameter $\sigma_T$]{\label{fig:trends} Set of scatterplots showing one draw each from the trend model $M_T$ for parameter values of  $\sigma_T \in \{0.1, 0.2, 0.3, 0.4\}$.}
\end{figure}
...
{\centering \includegraphics[width=\textwidth]{Figure/FeatureHierarchy/fig-cluster-1} 
...
{\centering \includegraphics[width=\textwidth]{Figure/FeatureHierarchy/fig-lambda-1} 
...
\end{knitrout}
\caption[Effect of null model $M_0$ mixture parameter $\lambda$]{\label{fig:lambda} Scatterplots of data generated from $M_0$ using different values of $\lambda$, generated using the same random seed at each $\lambda$ value.}
\end{figure}
...
for each data set generated, the previously described statistics for  trend  and cluster strength were computed. We compared the statistics for the relevant target plot to the most extreme value for the 18 null plots. The simulations themselves are described below; results are shown in figures \ref{fig:targetsignal}, \ref{fig:simulationLineIntervals} and \ref{fig:simulationClusterIntervals}. 

\paragraph{Distribution of Test Statistics}

Simulating lineup data sets, we can compare test statistics measuring trend strength and cluster strength for null and target plots. These distributions allow us to objectively assess the difficulty of detecting the target datasets computationally (without relying on human perception). This approach is similar to that taken in \citet{niladri:2014}.
...
{\centering \includegraphics[width=\maxwidth]{Figure/FeatureHierarchy/fig-null-distribution-1} 
...
\end{knitrout}
\caption[Simulated difference in null and target plot distributions]{\label{fig:targetsignal}Density of test statistics measuring trend strength and cluster strength for target distributions and null plots. }
\end{figure}

Figure~\ref{fig:targetsignal} show computed densities of the maximum null distribution measure compared with the measure in the signal plot. There is some overlap in the distribution of $R^2$ for the null plots compared with the target plot displaying data drawn from $M_T$. The cluster measure examines the variance in $x$ and $y$ described by the cluster center, and is used to compare data generated under $M_C$ to data generated under $M_0$.
%; the gini coefficient examines the inequality in group sizes. These simulations indicate that it may be possible to differentiate $M_C$ based on two different features in clustered data. In future experiments, it may be beneficial to control cluster size more tightly to remove this additional feature. 

The distribution of the cluster statistic values are more easily separated from the null plots than the distribution of the line statistic, indicating that $\sigma_C = 0.20$ is producing target plots that are a bit easier to spot than trend targets with a parameter value of $\sigma_T = 0.25$. A more thorough examination of the parameter space is shown in the next paragraph. 
%, however, the inequality of group sizes may distract participants from the intended target signal of cluster cohesion.

\paragraph{Full Parameter Space Simulation Study}
...
\caption[Simulated IQR of $R^2$ values for target and null data distributions.]{Simulated interquartile range of $R^2$ values for target and null data distributions. \label{fig:simulationLineIntervals}}
\end{figure}

\begin{figure}\centering

\caption[Simulated IQR of cluster cohesion statistic values for target and null data distributions.]{Simulated interquartile range of cluster cohesion statistic values for target and null data distributions. \label{fig:simulationClusterIntervals}}
\end{figure}
...
{\centering \includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-1} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-2} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-3} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-4} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-5} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-6} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-7} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-8} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-9} 
\includegraphics[width=.3\linewidth]{Figure/FeatureHierarchy/fig-samplepics-10} 
...
\end{knitrout}
\caption[Example study lineups for each of 10 aesthetic combinations]{Each of the 10 plot feature combinations tested in this study, with $K=3$, $\sigma_T=0.25$ and $\sigma_C=0.20$. \label{fig:plotExamples}}
\end{figure}
\clearpage
...
\end{tabular}
\caption[Theoretical impact of plot aesthetics]{Plot aesthetics and statistical layers which impact perception of statistical plots, according to gestalt theory. \label{tab:plotaesthetics}}
\end{table}
...
\end{knitrout}
\caption[Colors evaluated for maximum preattentive differences]{Colors in \protect\citet{heer:2014}. This study removed gray from the palette to make the experiment more inclusive of participants with colorblindness.}\label{fig:colors}
\end{figure}

The color palette used in \citet{heer:2014} and shown in figure \ref{fig:colors} is derived from colors available in Tableau visualization software. 
% \comment{citation for Tableau?}
...
\end{knitrout}
\caption[Shapes evaluated for maximum preattentive differences]{Shapes in \protect\citet{heer:2014}. In order to control for varying point size due to Unicode vs. non-Unicode characters, the last two shapes were removed.}\label{fig:shapes}
\end{figure}
...
during which time 1356 individuals completed 13519 unique lineup evaluations. Participants who completed fewer than 10 lineups were removed from the study (159 participants, 1060 evaluations), and lineup evaluations in excess of 10 for each participant were also removed from the study (421 evaluations). 
...
{\centering \includegraphics[width=.48\textwidth]{Figure/FeatureHierarchy/fig-demographics-1} 
\includegraphics[width=.48\textwidth]{Figure/FeatureHierarchy/fig-demographics-2} 
...
\end{knitrout}
\caption{Basic demographics of participants.}\label{fig:demographics}
\end{figure}
...
{\centering \includegraphics[width=0.6\textwidth]{Figure/FeatureHierarchy/fig-targets-1} 
...
\end{knitrout}
\caption[Target plot identifications by users]{Target identifications by users. Users are not generally primed for one target over the other target.}\label{fig:targets}
\end{figure}
...
\end{knitrout}
\caption[Odds of detecting the linear target plot for each aesthetic]{Odds of detecting the linear target plot for each aesthetic. Only the combination of Trend + Error significantly increases the odds of linear target plot detection relative to the control plot (plain scatterplot). }\label{fig:linear.fixef}
\end{figure}
...
\subsubsection{Group Target Selection}
...
Visually, the conspicuous absence of an ellipse would lead participants to select null plots with that feature.
...
{\centering \includegraphics[width=.85\textwidth]{Figure/FeatureHierarchy/fig-group-vs-line-1} 
...
\end{knitrout}
\caption[Estimated odds of decision for group versus line targets]{ Estimated odds of decision for group versus line target based on evaluations that resulted in the identification of one of these targets. Plot types are significantly different, if they do not share a letter as given on the left hand side of the plot.}\label{fig:faceoff}
\end{figure}
...
{\centering \includegraphics[width=\textwidth]{Figure/FeatureHierarchy/fig-timemodel-plottype-1} 
...
\end{knitrout}
\caption[Log evaluation time by outcome and plot aesthetics]{ Results of a model describing log evaluation time by evaluation outcome and plot type. Participants take less time to evaluate plots with a single aesthetic compared with more complicated plots. }\label{fig:timemodel-aes}
\end{figure}

Next, we model log response time a function of the plot type, first trial, and the interaction between the outcome and data-generation parameters $\sigma_C$, $\sigma_T$, and $K$. In order to model the task as designed, we have coded $\sigma_C$ and $\sigma_T$ according to difficulty level - easy, medium, and hard, rather than modeling the numerical parameters themselves; this allows us to describe the psychological task rather than the numerical task (and also simplifies the model slightly). Figure \ref{fig:timemodel-pars} shows the estimated difference in time as a function of difficulty level and trial outcome. 
...
{\centering \includegraphics[width=.8\textwidth]{Figure/FeatureHierarchy/fig-timemodel-pars-1} 
...
\end{knitrout}
\caption[Log evaluation time by outcome and plot type.]{Results of a model describing log evaluation time by evaluation outcome and plot type. Participants take less time to evaluate plots with a single aesthetic compared with more complicated plots. }\label{fig:timemodel-pars}
\end{figure}
\input{Figure/FeatureHierarchy/timemodel-pars-fixef-table}

\subsection{Participant Confidence}

In addition to participant identification of target plots, we also asked that participants to rate their confidence in their answer. 
...
\end{knitrout}
\caption{Participant confidence levels compared with evaluation outcome.}
\label{fig:conflevel}
\end{figure}
