...
{\centering \includegraphics[width=\linewidth]{Figure/sineIllusion/fig-UncorRresults} 
...
\end{subfigure}
\begin{subfigure}[b]{.32\textwidth}\centering
% \includegraphics[width=\linewidth,keepaspectratio=TRUE]{fig-trigFix2}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}

{\centering \includegraphics[width=\linewidth]{Figure/sineIllusion/fig-LinearResults} 
...
{\centering \includegraphics[width=\linewidth]{Figure/sineIllusion/fig-CtsAdjustedResults} 
...
% \begin{figure}[h!tbp]\centering
% \includegraphics[keepaspectratio=TRUE, width=.8\linewidth]{fig-CtsQuadratic}
...
% \includegraphics[width=\linewidth,keepaspectratio=TRUE]{fig-linearFixOvercorrect1}
% \caption{$\ell=5$, Uncorrected}
% \end{subfigure}
% \begin{subfigure}[b]{.3\linewidth}\centering
% \includegraphics[width=\linewidth,keepaspectratio=TRUE]{fig-linearFixOvercorrect2}
% \caption{Corrected by eqn. \ref{trigCorrection}}
% \end{subfigure}
% \begin{subfigure}[b]{.3\linewidth}\centering
% \includegraphics[width=\linewidth,keepaspectratio=TRUE]{fig-linearFixOvercorrect3}
...
\subsection{Results}
%
Participants were recruited from Amazon Mechanical Turk and the \href{http://reddit.com/r/SampleSize}{reddit} community. %203 participants in total took part in the study with 1330 total evaluations. 
...
{\centering \includegraphics[width=.5\linewidth]{Figure/sineIllusion/fig-meanDists} 
...
\begin{table}[htbp]\centering
%\input{Figure/sineIllusion/fixef.txt}
...
%\input{Figure/sineIllusion/ranef.txt}
% latex table generated in R 3.0.1 by xtable 1.7-1 package
% Tue Oct 15 14:37:59 2013
\begin{tabular}{rcccc}
  \hline
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'gasprices' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'gasprices' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: error in evaluating the argument 'x' in selecting a method for function 'subset': Error: object 'gasprices' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: error in evaluating the argument 'object' in selecting a method for function 'update': Error: object 'gasprices' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'monthly' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'gas' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'gas' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'gas' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: error in evaluating the argument 'x' in selecting a method for function 'unique': Error: object 'gas' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'gasprices' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: error in evaluating the argument 'x' in selecting a method for function 'subset': Error: object 'monthly' not found}}\end{kframe}
\end{knitrout}
