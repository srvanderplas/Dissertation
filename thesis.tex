...
\caption{Histogram}
\end{subfigure}
\caption{Types of plots in the first set of lineups. These plots are used to compare two distributions. }
\end{figure}
...
\end{subfigure}
\caption{Types of plots in the second set of lineups. These plots are used to compare two distributions. }
\end{figure}
...
\end{subfigure}
\caption{Types of plots in the third set of lineups. These plots are used to assess residual normality. }
\end{figure}
