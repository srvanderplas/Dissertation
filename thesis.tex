...
ISU Students & 83.4 (24.1) 
             & 12.4 (3.7)
             & 57.0 (23.8)\footnote{ISU students took only Part I due to time constraints.}
             & 21.9 (2.3)\\
Scaled Scores & 88.0 (34.8)
              & 13.8 (4.5)
              & 58.7 (14.4)\footnote{Averages calculated assuming 294 males and 323 females.}
              & -- \\
...
{\centering \includegraphics[width=.5\textwidth]{../Figure/VisualAptitude/fig-ResultsScaledScores-1} 
...
% Mon Nov 17 16:23:46 2014
\begin{table}[ht]
\centering
\caption{Results of lineup score modeled by single demographic variables. \label{tab:ttest-demographics}} 
\begin{tabular}{lrrrr}
  \hline
...
{\centering \includegraphics[width=.6\textwidth]{../Figure/VisualAptitude/fig-VisReasoningSPM-1} 

}

\caption{Pairwise scatterplots of test scores. Lineup scores are most highly correlated with figure classification scores, and are also highly correlated with card rotation scores. Paper folding and card rotation scores are also highly correlated.\label{fig:scatterplotmatrix}\label{fig:VisReasoningSPM}}
\end{figure}
...
A principal component analysis (PCA) of the four established visuo-spatial tests reveals that they all share a very strong first component, which explains about 64\% of the total variability. 
...
\newtext{PC1 accounts for about 60\% of the variance; figure~\ref{fig:biplots4} and table~\ref{tab:PCArotation4} confirm that PC1 is a measure of the similarity between all 4 tests; that is, a participant's general (or visual) aptitude. PC2 differentiates the figure classification test from the visual searching test, while}

% latex table generated in R 3.1.2 by xtable 1.7-1 package
% Mon Nov 17 16:23:46 2014
\begin{table}[htb]
\centering
\caption{PCA Rotation matrix for the four cognitive tests.\label{tab:PCArotation4}} 
\begin{tabular}{rrrrr}
  \hline
 & PC1 & PC2 & PC3 & PC4 \\ 
  \hline
...
PC3 differentiates these two from the paper folding test. PC4 is not particularly significant (it accounts for 5.9\% of the variance), but it differentiates the card rotation task from the paper folding task.

\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}

{\centering \includegraphics[width=.8\textwidth]{../Figure/VisualAptitude/fig-biplot-pca4-1} 

}

\caption{Plots of principal components 1-4 with observations. PCA was performed on the four cognitive tests used to understand the cognitive demands of the lineup protocol.  \label{fig:biplots4}\label{fig:biplot-pca4}}
\end{figure}
...
{\centering \includegraphics[width=.8\textwidth]{../Figure/VisualAptitude/fig-biplots-pca5-1} 

}

\caption{Plots of principal components 2-5 with observations. \label{fig:biplots5}\label{fig:biplots-pca5}}
\end{figure}
...
{\centering \includegraphics[width=.75\textwidth]{../Figure/VisualAptitude/fig-lineupblockpca-1} 

}

\caption[Lineup block PCA rotation matrix in graphical form]{Lineup block PCA rotation matrix in graphical form.\label{fig:lineupblockpca}}
\end{figure}
...
%as.numeric(round(100*importance[6], 1))\% and as.numeric(round(100*importance[7], 1))\% of the variance, respectively; PC6 seems to differentiate the first two lineup tasks from the overlap between the third lineup task and the figure classification task.
...
{\centering \includegraphics[width=.5\textwidth]{../Figure/VisualAptitude/fig-lineup-types-1} 

}

\caption{Plot of scaled scores for different types of lineups\label{fig:plottypesdensity}\label{fig:lineup-types}}
\end{figure}
...
{\centering \includegraphics[width=.6\textwidth]{../Figure/VisualAptitude/fig-lineup-types-scores-1} 

}

\caption{Plot of scaled lineup scores by aptitude test scores.\label{fig:scatterplottypes}\label{fig:lineup-types-scores}}
\end{figure}
