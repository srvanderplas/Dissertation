...
\section{Results}
We have tested 18 students, and are considering increasing sample size once the summer semester begins. Preliminary results are presented graphically in Figure \ref{fig:visualaptitudedata}.




\begin{figure}[htbp]\centering
\includegraphics[width=\textwidth]{fig-VisReasoningAnalysis}
\caption[Visual Aptitude Study Results]{Preliminary results of numeric variables compared to lineup score.}\label{fig:visualaptitudedata}
\end{figure}
