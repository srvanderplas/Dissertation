...
\begin{figure}[hbtp]
\centering
<<original, dependson='functions', echo=FALSE, fig.width=5, fig.height=4, out.width=".4\\linewidth">>=
...
\begin{subfigure}[b]{.31\linewidth}
  \centering
<<simulation1Sine,echo=F,out.width='\\linewidth',fig.width=4,fig.height=4>>=
alph <- .25
...
<<simulation1Sine2,echo=F,out.width='\\linewidth',fig.width=4,fig.height=4>>=
alph <- .25
x <- rep(seq(0,2*pi*2, length=120), each=50)
...
\end{subfigure}
\begin{subfigure}[b]{.31\linewidth}\centering
<<simulation1Sine3,echo=F,out.width='\\linewidth',fig.width=4,fig.height=4>>=
...
print(fixeftab, include.rownames=FALSE, file=paste(imgdir, "fixef.txt", sep=""), floating=FALSE, caption.placement="top")
...
print(ranefCIstab, include.rownames=FALSE, file=paste(imgdir, "ranef.txt", sep=""), floating=FALSE, caption.placement="top")
@
...
@
\begin{figure}[h!tbp]
<<gasprices-pictures,echo=F, include=T, fig.width=8, fig.height=2.5, out.width=".98\\linewidth", dependson='gasprices'>>=
...
\end{figure}
\begin{figure}\centering
<<gaspricevariance,echo=F,include=T, fig.width=6, fig.height=2.5, out.width=".7\\linewidth", dependson='gasprices'>>=
