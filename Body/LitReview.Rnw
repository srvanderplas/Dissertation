...
library(ggplot2)
data(faithful)
qplot(waiting, eruptions, geom="point", data=faithful) + xlab("Time Between Eruptions (minutes)") + ylab("Eruption Time (minutes)") + ggtitle("Old Faithful Eruptions") + geom_smooth(method="lm")
@
