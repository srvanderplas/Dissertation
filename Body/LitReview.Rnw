...
\begin{subfigure}[b]{.27\textwidth}\centering
  ...
  \caption{Tritanomaly}
\end{subfigure}\hfil
\caption[Colorblindness and Rainbow Color Schemes]{Rainbow color scheme with simulations of each of the three types of colorblindness in which a cone is entirely missing. The original image is from \protect\citet{light2004end}}\label{fig:colorblindrainbow}
\end{figure}
...
\begin{subfigure}[b]{.3\textwidth}\centering
  ...
  \caption{Shape}\label{preattentiveshape}
\end{subfigure}\hfill
\begin{subfigure}[b]{.3\textwidth}\centering
  \includegraphics[width=\textwidth]{fig-preattentive12}
  \caption{Color}\label{preattentivecolor}
\end{subfigure}\hfill
\begin{subfigure}[b]{.3\textwidth}\centering
  \includegraphics[width=\textwidth]{fig-preattentive22}
  \caption{Interference}\label{preattentiveinterference}
\end{subfigure}
\caption{Shape and color are detected preattentively in figures (a) and (b), but interfere in figure (c) so that location of the target in (c) is no longer preattentive.}\label{preattentive}
\end{figure}
