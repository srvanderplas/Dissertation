...
\subsection{Cognitive Load}\label{cognitiveload} Short term memory and other considerations
...
\begin{figure}[htbp]\centering
\includegraphics[width=.8\textwidth]{VisualSearch}
