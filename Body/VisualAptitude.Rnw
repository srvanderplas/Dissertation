...
pca2 <- prcomp(ans.summary[,c("card_rot", "fig_class", "folding", "vis_search")], scale=T, retx=T)
print(xtable(summary(pca2), caption=c("Importance of principal components in an analysis of four tests of spatial ability: figure classification, paper folding, card rotation, and visual search.\\label{tab:PCAvariance4}", "Spatial ability test principal component importance matrix"),digits=2), sanitize.text.function=sanitize, sanitize.rownames.function=sanitize, sanitize.colnames.function=sanitize, size="footnotesize", table.placement="htb", caption.placement="top")
@
...
print(xtable(pca2$rotation, caption=c("Rotation matrix for principal component analysis of the four cognitive tests (visual search, paper folding, card rotation, figure classification).\\label{tab:PCArotation4}", "Spatial ability test principal component rotation matrix"),digits=2), sanitize.text.function=sanitize, sanitize.rownames.function=sanitize, sanitize.colnames.function=sanitize, table.placement="htb", caption.placement="top")
@
...
print(xtable(summary(pca), caption=c("Importance of principal components, analyzing all five tests.\\label{tab:PCAvariance5}", "Importance of principal components for all five tests"),digits=2), sanitize.text.function=sanitize, sanitize.rownames.function=sanitize, sanitize.colnames.function=sanitize, size="footnotesize", table.placement="ht", caption.placement="top")
@

<<pcarotation5,echo=F, results='asis'>>=
print(xtable(pca$rotation, caption=c("Principal component analysis rotation matrix for all five tests.
             \\label{tab:PCArotation5}", "Principal component analysis rotation matrix for all five tests"),digits=2), sanitize.text.function=sanitize, sanitize.rownames.function=sanitize, sanitize.colnames.function=sanitize, table.placement="ht", caption.placement="top")
@
...
library(xtable)
print(xtable(summary(m1), caption=c("Estimates for a linear model of lineup scores.", "Estimates for a linear model of lineup scores"), label="tab:m1"), caption.placement="top")
@
...
\begin{figure}[htbp]\centering
\begin{subfigure}[b]{.49\linewidth}
\includegraphics[keepaspectratio=T,width=\linewidth]{Lineups2/file147f94f6965d7}
\caption{Boxplots.}
\end{subfigure}
\begin{subfigure}[b]{.49\linewidth}
\includegraphics[keepaspectratio=T,width=\linewidth]{Lineups2/file147f9e65f0e4}
\caption{Boxplots with jittered points.}
\end{subfigure}
\begin{subfigure}[b]{.49\linewidth}
\includegraphics[keepaspectratio=T,width=\linewidth]{Lineups2/file147f9fc58d73}
\caption{Bee swarm boxplots.}
\end{subfigure}
\begin{subfigure}[b]{.49\linewidth}
\includegraphics[keepaspectratio=T,width=\linewidth]{Lineups2/file147f93acbb7e4}
...
\begin{figure}[htbp]\centering
\begin{subfigure}[b]{.49\linewidth}
\includegraphics[keepaspectratio=T,width=\linewidth]{Lineups3/file13876a225d34-single}
\caption{QQ-plot with guide line.}
\end{subfigure}
\begin{subfigure}[b]{.49\linewidth}
\includegraphics[keepaspectratio=T,width=\linewidth]{Lineups3/file13877c93dc78-single}
\caption{QQ-plot with acceptance bands.}
\end{subfigure}
\begin{subfigure}[b]{.49\linewidth}
\includegraphics[keepaspectratio=T,width=\linewidth]{Lineups3/file13878e5c92f-single}
...
loadfonts()
qplot(x=0,  y=Var1, xend=value*importance, yend=Var1, geom="segment", data=rotation, arrow=arrow(length=unit(0.1, "cm"))) + facet_wrap(~Var2, ncol=7) + xlab("Influence") + ggtitle("Lineup Types and Visual Aptitude") + ylab("") + theme_bw() 
